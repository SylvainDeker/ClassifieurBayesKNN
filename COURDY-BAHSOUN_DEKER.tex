...
\subsection{Jeu de test}
 \paragraph{}
 Les jeux de test fournit montrent des classe distinctes les unes des autre pour les fichiers data2.csv  (voir \figurename{ \ref{data2}}) et pour le fichier data3.csv (voir \figurename{ \ref{data3_1}}, \figurename{ \ref{data3_2}} , \figurename{ \ref{data3_3}})
